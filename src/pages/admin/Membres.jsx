...
export const Membres = () => {
  const [membres, setMembres] = useState([
    { id: 1, nom: "Dupont", prenom: "Jean", email: "jean.dupont@mail.com" },
    { id: 2, nom: "Moreau", prenom: "Claire", email: "claire.moreau@mail.com" },
  ]);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const newMembre = { id: Date.now(), ...formData };
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {membres.map((membre) => (
                <tr key={membre.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">{membre.prenom}</td>
            ...
            <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input name="nom" value={formData.nom} onChange={handleChange} className="w-full border rounded px-3 py-2" required />
                </div>
                <div>
                  <label className="block text-sm font-medium">Prénom</label>
                  <input name="prenom" value={formData.prenom} onChange={handleChange} className="w-full border rounded px-3 py-2" required />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="password" name="motDePasse" value={formData.motDePasse} onChange={handleChange} className="w-full border rounded px-3 py-2" required />
                </div>
